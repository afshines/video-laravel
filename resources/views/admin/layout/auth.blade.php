...
<head>
    ...
    <link rel="stylesheet" href="/dist/css/skins/_all-skins-my.css">
    <!-- iCheck -->
    ...
    <link rel="stylesheet" href="/dist/persian-datepicker/dist/css/persian-datepicker-0.4.5.min.css"/>

    <!-- Select2 -->
    <script src="/plugins/select2/select2.full.min.js"></script>
    <script src="/plugins/select2/i18n/fa.js"></script>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/admin') }}" class="logo">
            ...
            <span class="logo-mini"><img width="46px" src="/img/logo.png"> </span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img width="75px" src="/img/logo.png"></span>
        </a>
                    ...
                    @endif
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="/img/logo.png" class="img-circle" alt="User Image">
                                <p>
                                    رسانه منجی - توسعه دهنده سمت کاربر
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/users"><i class="fa fa-circle-o"></i> مشاهده فهرست</a></li>
                        <li><a href="/admin/user_register"><i class="fa fa-circle-o"></i>ثبت نام نمایندگی</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/videos"><i class="fa fa-circle-o"></i> مشاهده فهرست</a></li>
                        <li><a href="/admin/upload"><i class="fa fa-circle-o"></i> ثبت ویدیو جدید</a></li>
                    </ul>
                </li>
...
<script src="/dist/persian-date/dist/0.1.8/persian-date-0.1.8.min.js"></script>
<script src="/dist/persian-datepicker/dist/js/persian-datepicker-0.4.5.min.js"></script>
